...
from descidb.types.chunker import ChunkerType
...
def recursive_character(text: str, chunk_size: int = 1000, overlap: int = 100) -> List[str]:
...
def semantic_split(text: str, min_chunk_size: int = 200, max_chunk_size: int = 1000) -> List[str]:
